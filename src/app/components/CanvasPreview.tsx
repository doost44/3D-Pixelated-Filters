...
export default function CanvasPreview({ canvasRef, videoLoaded }: CanvasPreviewProps) {
  useEffect(() => {
    ...
    <div className="flex-1 flex items-center justify-center relative">
      {!videoLoaded && (
        ...
        >
          ...
          <div className="text-sm mt-2 opacity-60">Upload a video to begin</div>
          <div
      ...
      <canvas
        ref={(el) => { if (el) canvasRef.current = el; }}
        width={600}
        height={600}
        style={{
